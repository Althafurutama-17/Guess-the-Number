...
The number range is **100–999** (Pro / Brain Burn).
...
- 🧠 **Pro Mode (Brain Burn, 100–999)** — the only active level. Tips: direction (higher/lower), odd/even, divisible by 3, digit product, left-to-right digit subtraction, and digit sum.
...
**v2.4 (15 July 2026)**
- Fixed bug where pressing Enter on second turn advanced to next round instead of next turn
- Fixed bug where player 2 couldn't lock if player 1 hadn't locked yet
- Improved multiplayer UI visual distinction with player-specific background colors (P1 blue, P2 red) and stronger locked-state gradients
- Improved input area UX with 90% width (max 280px), centered; status text "Belum Dikunci"; hint "Tekan Enter untuk mengunci jawaban"
- Updated range to 100–999 (was 100–1000)
